          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-100 p-4 sm:p-6">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 sm:gap-6">
              <div className="flex items-center space-x-2 sm:space-x-3">
                <div className="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 bg-blue-50 rounded-lg flex-shrink-0">
                  <Filter className="h-4 w-4 sm:h-5 sm:w-5 text-blue-600" />
                </div>
                <div>
                  <h3 className="text-base sm:text-lg font-semibold text-gray-900">Filter Briefings</h3>
                  <p className="text-xs sm:text-sm text-gray-500">Choose a profile to see specific content</p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <select
                  ...
                  className="w-full sm:min-w-[200px] bg-white border-2 border-gray-200 rounded-lg sm:rounded-xl px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-gray-500 [&:has(option:checked:not([value='']))]:text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 shadow-sm hover:border-gray-300"
                >
                ...
                {selectedProfile && (
                  <button
                    ...
                    className="px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-gray-600 hover:text-gray-800 transition-colors duration-200 flex items-center justify-center space-x-2"
                  >
            ...
            {selectedProfile && (
              <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-gray-100">
                <div className="flex flex-wrap items-center gap-2">
                  <span className="text-xs sm:text-sm text-gray-600">Showing briefings for:</span>
        ...
        {briefings.length === 0 ? (
          <div className="text-center py-12 sm:py-20">
            <div className="max-w-md mx-auto px-4">
              ...
              <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-2 sm:mb-3">No briefings found</h3>
              ...
              {selectedProfile && (
                <button
                  onClick={() => setSelectedProfile('')}
                  className="mt-4 sm:mt-6 inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 border border-transparent text-sm sm:text-base font-medium rounded-lg sm:rounded-xl text-white bg-blue-600 hover:bg-blue-700 transition-colors duration-200"
                >
                  View All Briefings
                </button>
              )}
          ...
          <div className="grid gap-4 sm:gap-6 lg:gap-8">
            {briefings.map((briefing, index) => (
              <div
                key={briefing.id}
                className="group bg-white rounded-xl sm:rounded-2xl border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden transform hover:-translate-y-1"
                ...
                <div className="p-4 sm:p-6 lg:p-8">
                  ...
                  <div className="flex items-start justify-between mb-4 sm:mb-6">
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                        ...
                        <span className="inline-flex items-center px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-800">
                  ...
                  {briefing.summary && (
                    <div className="mb-4 sm:mb-6">
                      <div className="bg-gradient-to-r from-gray-50 to-blue-50 rounded-lg sm:rounded-xl p-4 sm:p-6 border-l-4 border-blue-500">
                  ...
                  {/* Action Buttons */}
                  <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 sm:gap-4 pt-4 sm:pt-6 border-t border-gray-100">
                    <Link
                      href={`/briefing/${briefing.id}`}
                      className="inline-flex items-center justify-center px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm sm:text-base font-semibold rounded-lg sm:rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
                    >
                    ...
                    <Link
                      ...
                      className="inline-flex items-center justify-center sm:justify-start text-sm sm:text-base text-blue-600 hover:text-blue-800 font-medium transition-colors duration-200 group"
                    >
